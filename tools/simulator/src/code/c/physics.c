...
double handleSpeed(int alreadyTurning, double currentSpeed, double distanceToTurn, double tyreWear, double tyreType, double driversBrakingSkill,
             ...
             double distanceToCarAheadSquared, double speedOfCarAhead, double downforceOfCarAhead, float wasOvertaken)
{
    // gettimeofday(&t1, NULL);
    // srand(t1.tv_usec * t1.tv_sec);
    ...
    double distanceToCarAhead = sqrt(distanceToCarAheadSquared);
...
double slipstreamMultiplier(double distanceToCarAheadSquared, double speedOfCarAhead, double downforceOfCarAhead, /*double speed,*/ float wasOvertaken)
{
    ...
    // printf("b\n");
    if (distanceToCarAheadSquared < 0) return 0;
    // printf("c\n");
    ...
    return 1 + ((downforceOfCarAhead * speedOfCarAhead) / (1000 * distanceToCarAheadSquared));
}
